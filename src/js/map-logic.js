...
const config = {
    NO2: { unit: "µg/m³", conversion: 1, stops: [ { val: 0, c: [0, 100, 150] }, { val: 5, c: [0, 100, 150] }, { val: 15, c: [194, 195, 126] }, { val: 50, c: [222, 117, 53] }, { val: 100, c: [74, 12, 0] } ] },
    PM10: { unit: "µg/m³", conversion: 1, stops: [ { val: 0, c: [1, 101, 150] }, { val: 10, c: [1, 101, 150] }, { val: 25, c: [172, 186, 189] }, { val: 100, c: [212, 151, 79] }, { val: 200, c: [74, 12, 0] } ] },
    O3: { unit: "µg/m³", conversion: 1, stops: [ { val: 0, c: [1, 101, 150] }, { val: 10, c: [1, 101, 150] }, { val: 20, c: [1, 101, 150] }, { val: 100, c: [176, 178, 132] }, { val: 1000, c: [74, 12, 0] } ] },
    CO: { unit: "mg/m³", conversion: 1, stops: [ { val: 0, c: [1, 101, 150] }, { val: 0.5, c: [124, 124, 116] }, { val: 2, c: [124, 113, 60] }, { val: 5, c: [46, 29, 29] }, { val: 10, c: [130, 26, 25] } ] },
    SO2: { unit: "µg/m³", conversion: 1, stops: [ { val: 0, c: [0, 102, 151] }, { val: 10, c: [50, 135, 175] }, { val: 25, c: [195, 195, 125] }, { val: 50, c: [217, 113, 51] }, { val: 100, c: [74, 12, 0] } ] }
};
