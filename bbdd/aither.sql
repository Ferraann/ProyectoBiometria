...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-11-2025 a las 18:02:17
...
INSERT INTO `incidencias` (`id`, `id_tecnico`, `id_user`, `titulo`, `descripcion`, `fecha_creacion`, `fecha_finalizacion`, `estado_id`) VALUES
(1, 19, 19, 'prueba', 'adfsgfrtfnhygjmh,mdfsa', '2025-11-20 09:03:37', NULL, 1),
(2, 19, 1, 'Sensor sin conexión', 'El sensor MAC-001 no transmite datos desde ayer por la tarde.', '2025-11-20 13:30:00', NULL, 1),
(3, 19, 2, 'Lectura errática de humedad', 'Los valores de humedad saltan de 30 % a 90 % sin motivo aparente.', '2025-11-19 08:15:00', NULL, 2),
(4, 19, 3, 'Batería baja en nodo exterior', 'El nodo ubicado en jardín muestra 5 % de batería.', '2025-11-18 15:45:00', NULL, 3),
(5, 19, 2, 'Ruido en sensor de CO₂', 'Gráfica con picos anómalos cada 5 minutos.', '2025-11-17 10:00:00', NULL, 4),
(6, 19, 3, 'Caja abierta', 'La tapa del sensor está rota y expone la placa a la lluvia.', '2025-11-16 07:20:00', NULL, 1),
(7, 19, 1, 'Pérdida de GPS', 'La localización aparece como 0,0.', '2025-11-15 12:10:00', NULL, 2),
(8, 19, 3, 'Temperatura congelada', 'Hace 24 h que el valor no cambia: siempre 25,3 °C.', '2025-11-14 06:55:00', NULL, 3),
(9, 19, 2, 'Firmware desactualizado', 'Versión 1.0.3 reporta error de checksum al arrancar.', '2025-11-13 11:30:00', NULL, 5),
(10, 19, 2, 'LED de estado apagado', 'El led verde no parpadea, aunque los datos llegan correctamente.', '2025-11-12 17:40:00', NULL, 4),
(11, 19, 1, 'Antena doblada', 'El dispositivo recibió un golpe y la antena está deformada.', '2025-11-11 09:05:00', NULL, 1);
